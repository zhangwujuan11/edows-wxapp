...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"易到大咖商城","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/***/ 26:
/*!**********************************************!*\
  !*** D:/XM/edow微信小程序/edows-wxapp/pages.json ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 27:
/*!**************************************************!*\
  !*** D:/XM/edow微信小程序/edows-wxapp/store/index.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 35:
/*!************************************************!*\
  !*** D:/XM/edow微信小程序/edows-wxapp/Api/index.js ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.default = void 0;
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 25));
var _config = __webpack_require__(/*! ./config.js */ 36);
var axios = function axios(opts, data) {
  // uni.showToast({
  // 	title: opts.url,
  // 	icon: "none",
  // 	duration: 2000
  ...
  var promise = new Promise(function (resolve, reject) {
    uni.request(httpDefaultOpts).then(function (res) {
      ...
      if (res[1].data.code == 200) {
        ...
        var carUrl = _config.web.apiUrl + 'mall/shoppingCart/List?token=';
        if (httpDefaultOpts.url == carUrl) {} else {
          uni.reLaunch({
...
/***/ 36:
/*!*************************************************!*\
  !*** D:/XM/edow微信小程序/edows-wxapp/Api/config.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
module.exports = {
  web: {
    apiUrl: 'https://mall.edows.cn/api/'

    // apiUrl: 'http://27.155.120.108:51086/api/',
    // apiUrl: 'http://192.168.110.161:8086/api/',
    // webUrl: 'http://www.txsofts.com/webMell/',
    // apiUrl: 'https://ydmall.txsofts.com/api/'
    // webUrl: 'http://www.txsofts.com/webMell/',
  }
};
...
/***/ 37:
/*!**************************************************!*\
  !*** D:/XM/edow微信小程序/edows-wxapp/Api/baseUrl.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var serviceModule = {
  //微信授权 
  getXcxAuth: {
    url: _config.web.apiUrl + 'wx/xcxAuth',
    method: 'GET'
  },
  //小程序授权提交用户信息
  xcxDoAuth: {
    url: _config.web.apiUrl + 'wx/xcxDoAuth',
    method: 'POST'
  },
  //商城登录
  mallMemberLogin: {
    url: _config.web.apiUrl + 'member/mall/login',
    method: 'POST'
  },
  //获取所有品牌信息
  getCarBrandList: {
    url: _config.web.apiUrl + 'car/brand/list',
    method: 'GET'
  },
  //获取获取车系下的车型
  getCarInfoList: {
    url: _config.web.apiUrl + 'car/info/list',
    method: 'GET'
  },
  //获取品牌下的车系
  getCarSeriesList: {
    url: _config.web.apiUrl + 'car/series/list',
    method: 'GET'
  },
  //获取首页数据 
  getHomePageData: {
    url: _config.web.apiUrl + 'mall/product/getHomePageData',
    method: 'GET'
  },
  //记录广告访问Log
  visitLog: {
    url: _config.web.apiUrl + 'mall/advertisement/visitLog?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'POST'
  },
  //获取商品一级分类数据 
  getProductFirstGroup: {
    url: _config.web.apiUrl + 'mall/product/firstGroup',
    method: 'GET'
  },
  //零售用户预约服务 
  subReservationService: {
    url: _config.web.apiUrl + 'mall/reservationService/submit?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'POST'
  },
  //获取商品二级分类数据 
  getProductSecondGroup: {
    url: _config.web.apiUrl + 'mall/product/secondGroup/list?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'GET'
  },
  //关键词模糊搜索 
  getSearchKeywords: {
    url: _config.web.apiUrl + 'mall/product/getHeatSearchKeywordsLike?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'GET'
  },
  //商品检索
  searchProduct: {
    url: _config.web.apiUrl + 'mall/product/search?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'POST'
  },
  //获取商品详情数据 
  getProductByCode: {
    url: _config.web.apiUrl + 'mall/product/detail?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'POST'
  },
  //获取商品详情评价
  getProductComments: {
    url: _config.web.apiUrl + 'mall/comment/productComments?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'POST'
  },
  //获取地址列表
  getContactsList: {
    url: _config.web.apiUrl + 'mall/contacts/list?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'POST'
  },
  //新增编辑地址
  upDataContacts: {
    url: _config.web.apiUrl + 'mall/contacts/edit?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'POST'
  },
  //删除地址
  delContacts: {
    url: _config.web.apiUrl + 'mall/contacts/delete?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'GET'
  },
  //新增编辑发票
  upDataInvoice: {
    url: _config.web.apiUrl + 'mall/invoice/edit?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'POST'
  },
  //获取发票详情
  getInvoiceDetail: {
    url: _config.web.apiUrl + 'mall/invoice/detail?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'GET'
  },
  //获取发票列表
  getInvoiceList: {
    url: _config.web.apiUrl + 'mall/invoice/list?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'POST'
  },
  //删除发票
  delInvoice: {
    url: _config.web.apiUrl + 'mall/invoice/delete?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'GET'
  },
  //获取用户下指定状态的优惠券
  getCouponList: {
    url: _config.web.apiUrl + 'mall/coupon/user/list?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'POST'
  },
  //用户指定商品是否有可用的优惠券
  getCouponProductList: {
    url: _config.web.apiUrl + 'mall/coupon/user/product?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'GET'
  },
  //判断当前所选的产品及优惠券是否可用
  getCouponCheckUse: {
    url: _config.web.apiUrl + 'mall/coupon/check/use?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'POST'
  },
  //获取所有可用优惠券
  getAllCouponList: {
    url: _config.web.apiUrl + 'mall/coupon/list?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'GET'
  },
  //用户领取优惠券
  receiveUserCoupon: {
    url: _config.web.apiUrl + 'mall/coupon/user/receive?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'GET'
  },
  //查询购物城中所有的商品
  getShoppingCartList: {
    url: _config.web.apiUrl + 'mall/shoppingCart/List?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'POST'
  },
  //加入购物车
  addShoppingCart: {
    url: _config.web.apiUrl + 'mall/shoppingCart/add?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'POST'
  },
  //购物车选中操作
  shoppingCartChecked: {
    url: _config.web.apiUrl + 'mall/shoppingCart/checked?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'POST'
  },
  //更改购物车中商品的数量值
  editSumShoppingCart: {
    url: _config.web.apiUrl + 'mall/shoppingCart/editSum?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'POST'
  },
  //删除购物车
  delShoppingCart: {
    url: _config.web.apiUrl + 'mall/shoppingCart/delete?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'GET'
  },
  //点击结算或立即购买按钮
  toBuyProduct: {
    url: _config.web.apiUrl + 'mall/order/purchaseProduct?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'POST'
  },
  //提交订单
  submitOrder: {
    url: _config.web.apiUrl + 'mall/order/submitOrder?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'POST'
  },
  //一级门店待结算订单
  getDjsOrderList: {
    url: _config.web.apiUrl + 'mall/order/djsOrderList?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'POST'
  },
  //获取选中的订单信息
  getSelectedOrderList: {
    url: _config.web.apiUrl + 'mall/order/selectedOrder?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'GET'
  },
  //订单结算提交 
  submitOrderAccount: {
    url: _config.web.apiUrl + 'mall/order/orderAccountSubmit?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'POST'
  },
  //订单结算列表（结算中、已结算）
  getOrderAccountList: {
    url: _config.web.apiUrl + 'mall/order/orderAccountList?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'POST'
  },
  //订单结算详情
  getOrderAccountDetail: {
    url: _config.web.apiUrl + 'mall/order/orderAccountDetail?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'GET'
  },
  //上传图片
  uploadPic: {
    url: _config.web.apiUrl + 'mall/order/upload?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'POST'
  },
  //查询订单防伪编码信息
  getSecurityCodeList: {
    url: _config.web.apiUrl + 'mall/order/securityCodeList?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'POST'
  },
  //订单列表
  getOrderList: {
    url: _config.web.apiUrl + 'mall/order/list?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'POST'
  },
  //订单支付
  orderPayer: {
    url: _config.web.apiUrl + 'mall/order/payment?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'POST'
  },
  //确认收款
  orderConfirmation: {
    url: _config.web.apiUrl + 'mall/order/confirmation?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'GET'
  },
  //订单详情
  getOrderDetail: {
    url: _config.web.apiUrl + 'mall/order/detail?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'GET'
  },
  //退款说明原因选择
  getOrderRefundInfo: {
    url: _config.web.apiUrl + 'mall/order/refundInfo?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'POST'
  },
  //退款详情
  getOrderRefundDetail: {
    url: _config.web.apiUrl + 'mall/order/refundDetail?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'GET'
  },
  //取消退款操作
  canncelRefundApply: {
    url: _config.web.apiUrl + 'mall/order/canncelRefundApply?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'GET'
  },
  //去评价
  publishComment: {
    url: _config.web.apiUrl + 'mall/comment/publishComment?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'POST'
  },
  //退款申请提交
  orderRefundApply: {
    url: _config.web.apiUrl + 'mall/order/refundApply?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'POST'
  },
  //取消订单
  cancelOrder: {
    url: _config.web.apiUrl + 'mall/order/cancelOrder?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'GET'
  },
  //删除订单
  deleteOrder: {
    url: _config.web.apiUrl + 'mall/order/deleteOrder?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'GET'
  },
  // 线下付款
  offlinePay: {
    url: _config.web.apiUrl + 'mall/order/offlinePay?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'POST'
  },
  // 积分商品详情信息
  scoreGoodsDetail: {
    url: _config.web.apiUrl + 'mall/scoreGoods/detail?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'GET'
  },
  // 取消订单
  scoreGoodsCancel: {
    url: _config.web.apiUrl + 'mall/scoreGoods/order/cancel?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'GET'
  },
  // 确认收货
  scoreGoodsConfirmation: {
    url: _config.web.apiUrl + 'mall/scoreGoods/order/confirmation?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'GET'
  },
  // 创建积分商品订单
  scoreGoodsCreate: {
    url: _config.web.apiUrl + 'mall/scoreGoods/order/create?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'POST'
  },
  // 删除订单
  scoreGoodsDelete: {
    url: _config.web.apiUrl + 'mall/scoreGoods/order/delete?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'GET'
  },
  // 积分订单详情
  scoreGoodsOrderDetail: {
    url: _config.web.apiUrl + 'mall/scoreGoods/order/detail?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'GET'
  },
  // 积分订单列表
  scoreGoodsOrderList: {
    url: _config.web.apiUrl + 'mall/scoreGoods/order/list?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'POST'
  },
  // 积分支付结果查询
  queryPayResult: {
    url: _config.web.apiUrl + 'mall/scoreGoods/order/queryPayResult?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'GET'
  },
  // 积分支付
  scorePay: {
    url: _config.web.apiUrl + 'mall/scoreGoods/order/scorePay?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'POST'
  },
  // 积分记录
  scoreGoodsRecord: {
    url: _config.web.apiUrl + 'mall/scoreGoods/score/record?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'POST'
  },
  // 积分商品检索
  scoreGoodsSearch: {
    url: _config.web.apiUrl + 'mall/scoreGoods/search?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'POST'
  },
  // 积分商品检索
  score: {
    url: _config.web.apiUrl + 'mall/scoreGoods/user/score?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'GET'
  },
  scoreone: {
    url: _config.web.apiUrl + 'shop/getShopSecurityBalance?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'GET'
  },
  // 获取样板店余额
  ...
  // 获取样板流水
  getshopAccount: {
    url: _config.web.apiUrl + 'mall/shopAccountFlow/list?token=' + (uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').token : ''),
    method: 'GET'
  }
};
var ApiSetting = _objectSpread({}, serviceModule);
var _default = ApiSetting;
exports.default = _default;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 2)["default"]))
...
/***/ 38:
/*!*******************************************!*\
  !*** D:/XM/edow微信小程序/edows-wxapp/Json.js ***!
  \*******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 500:
/*!******************************************************!*\
  !*** D:/XM/edow微信小程序/edows-wxapp/components/data.js ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 56:
/*!**************************************************!*\
  !*** D:/XM/edow微信小程序/edows-wxapp/util/common.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var fn = {
  getClass: function getClass(oParent, sClass) {
  ...
  //清除所有的样式
  removeAllClass: function removeAllClass(el, className) {
  ...
  // 保存当前状态 
  activeState: function activeState(el, className) {
    var els = el.parentNode.children; // 所有同级
    for (var i = 0; i < els.length; i++) {
      fn.removeClass(els[i], className);
    }
  ...
  getData: function getData(el, name, val) {
    var prefix = 'data-';
    if (val) {
  ...
  //获取数组中相同元素的个数
  getSameNum: function getSameNum(val, arr) {
  ...
  //三位数字加个‘，’，尾数保留两位小数
  formatFix_number: function formatFix_number(number, decimals, dec_point, thousands_sep) {
    /*
     * 参数说明：
     * number：要格式化的数字
     * decimals：保留几位小数
  ...
  //文本框换行、空格保存
  textareaTo: function textareaTo(str) {
    var reg = new RegExp("\n", "g");
  ...
  //获得上周的开始日期
  getLastWeekStartDate: function getLastWeekStartDate() {
    var weekStartDate = new Date(nowYear, nowMonth, nowDay - nowDayOfWeek - 7);
    return this.formatDate(weekStartDate);
  },
  //获得上周的结束日期
  getLastWeekEndDate: function getLastWeekEndDate() {
...
/***/ 57:
/*!*****************************************************!*\
  !*** D:/XM/edow微信小程序/edows-wxapp/data/allBrands.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.carBrands = exports.addressBook = void 0;
var carBrands = {
    "Brand": []
  },
  addressBook = {};
exports.addressBook = addressBook;
exports.carBrands = carBrands;
