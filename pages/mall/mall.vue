<template>
	<view class="container">
		...
		<view class="topBg">
		  <view class="yd_top" style="margin-bottom: 20rpx;">
		    <view class="mp-search-box" @click="toKeySearch">
		      <text class="m-icon-search"></text>
		      <text class="ser-input">您要买什么？</text>
		    </view>
		  </view>
			<CustomTabBar :currentTab="currentTab" ></CustomTabBar>
		  <!-- <button open-type='contact'>点击进入客服会话</button> -->
		  <!-- 头部轮播 -->
		  <view class="carousel-section" style="margin-top:100rpx;">

		    <swiper class="carousel" @change="swiperChange">
		      <swiper-item v-for="(item, index) in bannerList" :key="index" class="carousel-item" @click="visitLog(item)">
		...
		<view class="seckill-section m-t">
			...
			<view class="s-header">
				...
				<view class="scoll-wrapper" style="justify-content: space-around;">
				<view v-for="(item, index) in hotProductList.slice(0,2)" :key="index" class="floor-item" style="width: 200upx;display: flex;flex-direction: column;justify-content: center;" @click="navToDetailPage(item)"
					v-if="index<4">
					<image   :src="item.masterImg" style="margin: 0 auto;width: 205rpx;height: 205rpx;"></image>
					<text class="title clamp">{{item.subName}}</text>
		...
		<view class="seckill-section m-t">
			<view class="inner-section">
				...
				<view class="s-header">
					<!-- <text>人气产品</text> -->
					<!-- <text class="yticon icon-you" >更多推荐</text> -->
					<image src="https://img.edows.cn/wx/floor2.png" class="pic-floor2"></image>
		...
		<view class="seckill-section m-t" style="padding:4rpx 30rpx 0rpx">
			<view class="inner-section">
				<view class="s-header">
					<!-- <text>热卖产品</text> -->
					<!-- <text class="yticon icon-you" >更多推荐</text> -->
					<image src="https://img.edows.cn/wx/floor3.png" class="pic-floor3"></image>
				</view>
				<!-- <scroll-view class="" scroll-x> -->
				<view class="scoll-wrapper">
		...
		<view class="showIcon" @click="toReserve" v-if="accountType==0">
			<image src="https://img.edows.cn/wx/showIcon.png"></image>
		</view>
...
<style lang="scss" scoped>
  ...
  .topBg {
	...
	background-color:  rgb(57, 158, 255);
