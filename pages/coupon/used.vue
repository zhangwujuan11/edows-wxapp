<template>
	<view class="content">
		...
		<button class="add-btn blueGraShadow" @click="confirm">保存</button>
								...
								success() {
									uni.chooseLocation({
										success: function(res) {
											console.log("地址：",res)
											_self.addressData.addressName = res.address +' ' + res.name
											_self.addressData.address = res.address +' ' + res.name
										}
									});
								}
							})
